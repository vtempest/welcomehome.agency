    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-6 py-6 lg:px-12">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/search" className="text-sm text-white/80 hover:text-white transition-colors flex items-center gap-2">
          ...
          <a href="#quote" className="text-sm text-white/80 hover:text-white transition-colors">Get Quote</a>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/dashboard?demo=true">
            <Button size="lg" variant="outline" className="bg-white/10 border-white/20 text-white hover:bg-white/20 backdrop-blur-sm text-base px-8 w-full sm:w-auto">
